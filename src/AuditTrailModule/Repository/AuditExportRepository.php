...
use App\AuditTrailModule\Entity\AuditExport;
...
class AuditExportRepository extends ServiceEntityRepository
{
    ...
    //    /**
    //     * @return AuditExport[] Returns an array of AuditExport objects
    //     */
    ...
    //    public function findOneBySomeField($value): ?AuditExport
    //    {
    //        return $this->createQueryBuilder('a')
    //            ->andWhere('a.exampleField = :val')
    //            ->setParameter('val', $value)
