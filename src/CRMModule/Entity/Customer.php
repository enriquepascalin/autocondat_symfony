...
use App\CRMModule\Repository\CustomerRepository;
...
class Customer
{
    ...
    #[ORM\Column(enumType: CustomerTypeEnum::class)]
    ...
    public function setCustomerType(CustomerTypeEnum $customerType): static
    {
